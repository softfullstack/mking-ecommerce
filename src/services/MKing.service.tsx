...
export const ToggleFavoriteService = (id: string) => axios.post(`${apiUrl}/favorites/${id}`);
export const DeleteFavoriteService = (id: string) => axios.delete(`${apiUrl}/favorites/${id}`);
